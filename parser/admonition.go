...
var defaultEnhancedAdmonitionParser = &enhancedAdmonitionParser{}

// NewEnhancedAdmonitionParser returns a new BlockParser that
// parses admonition blocks with support for both !!! and ??? syntax.
func NewEnhancedAdmonitionParser() parser.BlockParser {
	return defaultEnhancedAdmonitionParser
}
...
func (b *enhancedAdmonitionParser) Open(parent ast.Node, reader text.Reader, pc parser.Context) (ast.Node, parser.State) {
...
func (b *enhancedAdmonitionParser) Continue(node ast.Node, reader text.Reader, pc parser.Context) parser.State {
	// ========================================================================== //
...
func (b *enhancedAdmonitionParser) Close(node ast.Node, reader text.Reader, pc parser.Context) {
}

func (b *enhancedAdmonitionParser) CanInterruptParagraph() bool {
	return true
}

func (b *enhancedAdmonitionParser) CanAcceptIndentedLine() bool {
	return false
}
